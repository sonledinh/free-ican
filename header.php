                    ...
                    <div class="col-md-9">
                        <div class="h-menu">
                            <ul>
                                ...
                                <li><a href="" class="active"><img src="images/menu-2.svg" class="img-fluid"> Trang chủ</a></li>
                                <li><a href=""><img src="images/menu-2.svg" class="img-fluid"> Giới thiệu</a></li>
                                <li><a href=""><img src="images/menu-3.svg" class="img-fluid"> Lớp mới</a></li>
                                <li><a href=""><img src="images/menu-4.svg" class="img-fluid"> Đội ngũ gia sư</a></li>
                                <li><a href=""><img src="images/menu-5.svg" class="img-fluid"> Tin tức</a></li>
                                <li><a href=""><img src="images/menu-6.svg" class="img-fluid"> Tài liệu</a></li>
                            </ul>
                        </div> 
                    </div>
                    <div class="col-md-3">
          ...
          <div class="modal-body">
            <div class="content-popup">
                ...
                <div class="form-popup">
                    ...
                    <div class="item">
                        <p>Bạn đã có tài khoản?<a href="javascript:void(0)">Đăng nhập</a></p>
                    </div>
                </div>
            </div>
          </div>
